...
<main id="product">
    <section id="product-details">
        <div class="container product-variant-{$THEME_SETTINGS.product_card_view_type}
        ...
        {if $product.reservation == 'forced'} rs-forced-reserve{/if}"
         data-id="{$product.id}">
            ...
            <div class="row">
                <div class="col s12 product-page-title">
                    <h1>{$product.title}</h1>
                </div>
            </div>
            <div class="row flex">
...
{*                                <img src="{$brand.__image->getUrl(77, 40)}" srcset="{$brand.__image->getUrl(154, 80)} 2x" alt="{$brand.title}" title="{t brand=$brand.title}Бренд: %brand{/t}">*}
{*                            </a>*}
{*                        {/if}*}
{*                    {/if}*}
{*                </div>*}
