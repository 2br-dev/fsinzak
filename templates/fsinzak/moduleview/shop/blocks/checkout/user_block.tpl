...
{$recipient = \Fsinzak\Model\RecipientsApi::getCurrentRecipient()}
...
{if $is_auth}
    <div class="col l4 m6 s12">
        <div class="row">
            <div class="col s12"><h2>Покупатель</h2></div>
            <div class="col s12">
                <div class="input-field">
                    <input readonly type="text" placeholder="Фамилия" value="{$user.surname}">
                    <label for="">Фамилия</label>
                </div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field">
                    <input readonly type="text" placeholder="Имя" value="{$user.name}">
                    <label for="">Имя</label>
                </div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field">
                    <input readonly type="text" placeholder="Отчество" value="{$user.midname}">
                    <label for="">Отчество</label>
                </div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field">
                    <input readonly type="text" placeholder="Гражданство" value="{$user->getCitizen()}">
                    <label for="">Гражданство</label>
                </div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field">
                    <input readonly type="text" placeholder="Паспорт" value="{$user->getPasport()}">
                    <label for="">Паспорт</label>
                </div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field">
                    <input readonly type="text" placeholder="Телефон" value="{$user['phone']}">
                    <label for="">Телефон</label>
                </div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field">
                    <input readonly type="text" placeholder="E-mail" value="{$user['e_mail']}">
                    <label for="">E-mail</label>
                </div>
            </div>
            <div class="col s12 right-align">
                <a class="btn btn-flat rs-in-dialog" href="{$router->getUrl('fsinzak-front-profile', ['Act' => 'checkoutEdit'])}">Редактировать</a>
            </div>
        </div>
    </div>
    <div class="col l4 m6 s12">
        <div class="row">
            <div class="col s12"><h2>Получатель</h2></div>
            <div class="col s12">
                <div class="input-field">
                    <input readonly type="text" placeholder="Фамилия" value="{$recipient.surname}">
                    <label for="">Фамилия</label>
                </div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field">
                    <input readonly type="text" placeholder="Имя" value="{$recipient.name}">
                    <label for="">Имя</label>
                </div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field">
                    <input readonly type="text" placeholder="Отчество" value="{$recipient.midname}">
                    <label for="">Отчество</label>
                </div>
            </div>
            <div class="col s12">
                <div class="input-field"><input readonly type="text" placeholder="Колония" value="{$parent_affiliate['title']}, {$affiliate['title']}"><label for="">Колония</label></div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field"><input readonly type="text" placeholder="Дата рождения" value="{$recipient->getBirthday('d.m.Y')}"><label for="">Дата рождения</label></div>
            </div>
            <div class="col l6 m6 s6 xs12">
                <div class="input-field"><input readonly type="text" placeholder="Возраст" value="{$recipient->getAge()}"><label for="">Возраст</label></div>
            </div>
            <div class="col s12 right-align">
                <a class="btn btn-flat rs-in-dialog" href="{$router->getUrl('fsinzak-front-myrecipients', ['Act' => 'edit', 'recipient' => $recipient['id']])}">Редактировать</a>
            </div>
        </div>
    </div>
