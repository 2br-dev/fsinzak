...
{*    {addcss rel="preload" file="fonts/Manrope-Regular.woff2" as="font" type="font/woff2" crossorigin="anonymous" no_compress=true}*}
    ...
    {addcss file="https://cdn.jsdelivr.net/npm/suggestions-jquery@latest/dist/css/suggestions.min.css" rel="preload" basepath="root"}
    {addjs file="https://cdn.jsdelivr.net/npm/suggestions-jquery@latest/dist/js/jquery.suggestions.min.js" basepath="root" defer="true"}
