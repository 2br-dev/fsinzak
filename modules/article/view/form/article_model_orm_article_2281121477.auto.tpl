<div class="formbox" >
        ...
        <ul class="tab-nav" role="tablist">
                    ...
                    <li class=""><a data-target="#article-article-tab7" data-toggle="tab" role="tab">{$elem->getPropertyIterator()->getGroupName(7)}</a></li>
                </ul>
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        ...
                        <div class="tab-pane" id="article-article-tab6" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__type_news->getTitle()}&nbsp;&nbsp;{if $elem.__type_news->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__type_news->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__type_news->getRenderTemplate() field=$elem.__type_news}</td>
                                </tr>
                                
                                                                                    </table>
                                                </div>
                        <div class="tab-pane" id="article-article-tab7" role="tabpanel">
