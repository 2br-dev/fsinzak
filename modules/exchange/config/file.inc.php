        ...
        parent::_init()->append([
            t('Основные'),
                ...
                'lock_expire_interval' => new Type\Integer([
                    'description' => t('Время жизни блокировки обмена'),
                ]),
            t('Каталог товаров - импорт'),
                ...
                'full_name_to_description' => new Type\Integer([
                    'description' => t('Записывать значение из реквизита "Полное наименование" в Описание товара'),
                    'hint' => t('Обычно применяется при обмене с сервисом МойСклад'),
                    'maxLength' => 1,
                    'checkboxView' => [1, 0],
                    'default' => 0,
                ]),
