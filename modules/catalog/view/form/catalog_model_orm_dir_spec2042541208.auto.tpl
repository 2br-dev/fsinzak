<div class="formbox" >
        ...
        <ul class="tab-nav" role="tablist">
                    ...
                    <li class=""><a data-target="#catalog-dir-tab11" data-toggle="tab" role="tab">{$elem->getPropertyIterator()->getGroupName(11)}</a></li>
                    <li class=""><a data-target="#catalog-dir-tab12" data-toggle="tab" role="tab">{$elem->getPropertyIterator()->getGroupName(12)}</a></li>
                </ul>
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        <div class="tab-pane active" id="catalog-dir-tab0" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__label_text_color->getTitle()}&nbsp;&nbsp;{if $elem.__label_text_color->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__label_text_color->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__label_text_color->getRenderTemplate() field=$elem.__label_text_color}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__label_bg_color->getTitle()}&nbsp;&nbsp;{if $elem.__label_bg_color->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__label_bg_color->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__label_bg_color->getRenderTemplate() field=$elem.__label_bg_color}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__label_border_color->getTitle()}&nbsp;&nbsp;{if $elem.__label_border_color->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__label_border_color->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__label_border_color->getRenderTemplate() field=$elem.__label_border_color}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="catalog-dir-tab9" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__vk_dir->getTitle()}&nbsp;&nbsp;{if $elem.__vk_dir->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__vk_dir->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__vk_dir->getRenderTemplate() field=$elem.__vk_dir}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="catalog-dir-tab10" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__limit_18->getTitle()}&nbsp;&nbsp;{if $elem.__limit_18->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__limit_18->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__limit_18->getRenderTemplate() field=$elem.__limit_18}</td>
                                </tr>
                                
                                                                                    </table>
                                                </div>
                        <div class="tab-pane" id="catalog-dir-tab11" role="tabpanel">
                                                                                                                                                                                                                                                                                                                <table class="otable">
                        ...
                        <div class="tab-pane" id="catalog-dir-tab12" role="tabpanel">
                                                                                                                                                                        <table class="otable">
