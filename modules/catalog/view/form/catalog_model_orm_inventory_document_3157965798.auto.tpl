<div class="formbox" >
            ...
            <div class="notabs">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__provider->getTitle()}&nbsp;&nbsp;{if $elem.__provider->getHint() != ''}<a class="help-icon" title="{$elem.__provider->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__provider->getRenderTemplate() field=$elem.__provider}</td>
                                </tr>
