        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        ...
                        <div class="tab-pane" id="catalog-product-tab7" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__video_link->getTitle()}&nbsp;&nbsp;{if $elem.__video_link->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__video_link->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__video_link->getRenderTemplate() field=$elem.__video_link}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="catalog-product-tab8" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__availability->getTitle()}&nbsp;&nbsp;{if $elem.__availability->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__availability->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__availability->getRenderTemplate() field=$elem.__availability}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="catalog-product-tab11" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__tn_ved_codes->getTitle()}&nbsp;&nbsp;{if $elem.__tn_ved_codes->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__tn_ved_codes->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__tn_ved_codes->getRenderTemplate() field=$elem.__tn_ved_codes}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__gtd->getTitle()}&nbsp;&nbsp;{if $elem.__gtd->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__gtd->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__gtd->getRenderTemplate() field=$elem.__gtd}</td>
                                </tr>
