<div class="formbox" >
            ...
            <div class="notabs">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__warehouse_from->getTitle()}&nbsp;&nbsp;{if $elem.__warehouse_from->getHint() != ''}<a class="help-icon" title="{$elem.__warehouse_from->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__warehouse_from->getRenderTemplate() field=$elem.__warehouse_from}</td>
                                </tr>
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__warehouse_to->getTitle()}&nbsp;&nbsp;{if $elem.__warehouse_to->getHint() != ''}<a class="help-icon" title="{$elem.__warehouse_to->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__warehouse_to->getRenderTemplate() field=$elem.__warehouse_to}</td>
                                </tr>
