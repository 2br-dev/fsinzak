        ...
        $helper->setTable(new Table\Element([
            'Columns' => [
                ...
                new TableType\UserFunc('public', t('Опубликован'), function($value, $field) {
                    ...
                    return '<div class="toggle-switch rs-switch crud-switch ' . $switch . '" data-url="/admin/fsinzak-tools/?id=' . $review['id'] . '&do=AjaxToggleReviewPublic">
