...
<div class="previewConstructor">
    <div class="formbox" >
            ...
            <div class="notabs">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__container_type->getTitle()}&nbsp;&nbsp;{if $elem.__container_type->getHint() != ''}<a class="help-icon" title="{$elem.__container_type->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__container_type->getRenderTemplate() field=$elem.__container_type}</td>
                                </tr>
