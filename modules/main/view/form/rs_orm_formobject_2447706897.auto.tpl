        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        ...
                        <div class="tab-pane" id="rs-orm-formobject-tab2" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__enable_product_zoom->getTitle()}&nbsp;&nbsp;{if $elem.__enable_product_zoom->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__enable_product_zoom->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__enable_product_zoom->getRenderTemplate() field=$elem.__enable_product_zoom}</td>
                                </tr>
