        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        ...
                        <div class="tab-pane" id="affiliate-affiliate-tab5" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__creator_for_not_payment->getTitle()}&nbsp;&nbsp;{if $elem.__creator_for_not_payment->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__creator_for_not_payment->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__creator_for_not_payment->getRenderTemplate() field=$elem.__creator_for_not_payment}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__manager_for_not_payment->getTitle()}&nbsp;&nbsp;{if $elem.__manager_for_not_payment->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__manager_for_not_payment->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__manager_for_not_payment->getRenderTemplate() field=$elem.__manager_for_not_payment}</td>
                                </tr>
