...
{block "body"}
    <div class="mb-lg-4 mb-3 position-relative">
        ...
        <input type="text" class="form-control rs-city-search" id="input-city1" placeholder="{t}По названию{/t}" data-url-search="{$router->getUrl('affiliate-front-affiliates', ['Act' => 'ajaxSearch', 'referer' => $referer])}">
