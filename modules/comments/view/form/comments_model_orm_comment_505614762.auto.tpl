<div class="formbox" >
            ...
            <div class="notabs">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__admin_ask->getTitle()}&nbsp;&nbsp;{if $elem.__admin_ask->getHint() != ''}<a class="help-icon" title="{$elem.__admin_ask->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__admin_ask->getRenderTemplate() field=$elem.__admin_ask}</td>
                                </tr>
                                                                                                        </table>
                            </div>
        </form>
