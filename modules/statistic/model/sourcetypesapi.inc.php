...
{
    public static
            $source_types_cache_by_host = []; //список подгруженных источников по хосту
    ...
    {
        parent::__construct(new Orm\SourceType(), [
            'name_field' => 'title',
            'id_field' => 'id',
            'sort_field' => 'sortn',
            'multisite' => true,
    ...
    public static function getTypesListByHost($host)
    {
        if (!isset(self::$source_types_cache_by_host[$host])){
            ...
            uasort(self::$source_types_cache_by_host[$host], ['self', 'sortTypes']);
        }
