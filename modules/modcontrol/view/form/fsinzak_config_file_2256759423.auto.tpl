        ...
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none">
                            ...
                            <div class="tab-pane" id="fsinzak-config-file-tab4" role="tabpanel">
                                        ...
                                        <tr>
                                        <td class="otitle">{$elem.__auto_change_from_status->getTitle()}&nbsp;&nbsp;{if $elem.__auto_change_from_status->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__auto_change_from_status->getHint()|escape}">?</a>{/if}
                                        </td>
                                        <td>{include file=$elem.__auto_change_from_status->getRenderTemplate() field=$elem.__auto_change_from_status}</td>
                                        </tr>
