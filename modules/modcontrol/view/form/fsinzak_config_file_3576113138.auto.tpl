<div class="formbox" >
    {if $elem._before_form_template}{include file=$elem._before_form_template}{/if}
            ...
            <div class="notabs">
                                    ...
                                    <tr>
                                    <td class="otitle">{$elem.__water_dir_id->getTitle()}&nbsp;&nbsp;{if $elem.__water_dir_id->getHint() != ''}<a class="help-icon" title="{$elem.__water_dir_id->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__water_dir_id->getRenderTemplate() field=$elem.__water_dir_id}</td>
                                    </tr>
                                                                        </table>
                            </div>
        </form>
