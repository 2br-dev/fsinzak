<div class="formbox" >
        ...
        <ul class="tab-nav" role="tablist">
                    ...
                    <li class=""><a data-target="#site-config-tab5" data-toggle="tab" role="tab">{$elem->getPropertyIterator()->getGroupName(5)}</a></li>
                </ul>
        <form method="POST" action="{urlmake}" enctype="multipart/form-data" class="tab-content crud-form">
            <input type="submit" value="" style="display:none"/>
                        ...
                        <div class="tab-pane" id="site-config-tab1" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__logo_sm->getTitle()}&nbsp;&nbsp;{if $elem.__logo_sm->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__logo_sm->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__logo_sm->getRenderTemplate() field=$elem.__logo_sm}</td>
                                </tr>
                                
                                                                                                                            
                                <tr>
                                    <td class="otitle">{$elem.__logo_xs->getTitle()}&nbsp;&nbsp;{if $elem.__logo_xs->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__logo_xs->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__logo_xs->getRenderTemplate() field=$elem.__logo_xs}</td>
                                </tr>
                        ...
                        <div class="tab-pane" id="site-config-tab5" role="tabpanel">
                                ...
                                <tr>
                                    <td class="otitle">{$elem.__make_default_description_from_title->getTitle()}&nbsp;&nbsp;{if $elem.__make_default_description_from_title->getHint() != ''}<a class="help-icon" data-placement="right" title="{$elem.__make_default_description_from_title->getHint()|escape}">?</a>{/if}
                                    </td>
                                    <td>{include file=$elem.__make_default_description_from_title->getRenderTemplate() field=$elem.__make_default_description_from_title}</td>
                                </tr>
