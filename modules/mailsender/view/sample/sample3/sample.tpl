...
<div  offset="0" class="body" style="padding:0; margin:0; display:block; background:#eeebeb; -webkit-text-size-adjust:none" bgcolor="#eeebeb">
            ...
            <tr>
              <td style="background-color:#3bcdb0;">
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    <td style="font-size:24px; text-align:center; padding: 0 75px; color:#6f6f6f;" class="w320 mobile-spacing">
                      Ut nonummy. Fusce aliquet pede non pede. Suspendisse dapibus lorem
                    </td>
                  </tr>
                </table>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td>
                      <img src="{$sample_img_path}/comp.gif" style="max-width:100%; display:block;">
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              ...
              <table cellspacing="0" cellpadding="0" class="force-full-width">
                <tr>
                  <td width="230" class="mobile-hide">
                    <table cellspacing="0" cellpadding="0" class="force-full-width">
                      <tr>
                        <td background="{$sample_img_path}/robbonwide.gif" bgcolor="#ffffff" width="230" height="113" valign="top" style="background-repeat:no-repeat; ">
                          <!--[if gte mso 9]>
                ...
                <tr>
                  ...
                  <br>
                    <div><!--[if mso]>
                      ...
                      <![endif]-->
                          <a href="http://"
                        style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:180px;-webkit-text-size-adjust:none;">Pellentesque</a>
                          <!--[if mso]>
                        </center>
                      </v:rect>
                    <![endif]--></div>
              ...
              <table cellspacing="0" cellpadding="0" bgcolor="#363636"  class="force-full-width">
                <tr>
                  ...
                  <br>
                  <br>
                    <img width="62" height="56" src="{$sample_img_path}/gl.gif">
                    <img width="68" height="56" src="{$sample_img_path}/fb.gif">
                    <img width="61" height="56" src="{$sample_img_path}/tw.gif">
                  <br>
                  <br>
                  </td>
                </tr>
                <tr>
                  <td style="color:#f0f0f0; font-size: 14px; text-align:center; padding-bottom:4px;">
                    © {"now"|date_format:"Y"} {t}Все права защищены{/t}
                  </td>
                </tr>
                <tr>
                  <td style="color:#27aa90; font-size: 14px; text-align:center;">
                    <a href="#">{t}Веб-сайт{/t}</a> | <a href="#">{t}Контакты{/t}</a> | <a href="{ldelim}$unsubscribe_url{rdelim}">{t}Отписаться{/t}</a>
                  </td>
                </tr>
                <tr>
